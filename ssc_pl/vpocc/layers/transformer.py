...
# from .multi_scale_deform_attn import CustomMultiScaleDeformableAttention
import torch
    ...
    def __init__(self,
        ...
        if grid_size:
            self.attn = attn_layer(
                embed_dims, num_heads, num_levels, num_points, batch_first=True, grid_size=grid_size,**kwargs)
        else:
            self.attn = attn_layer(
