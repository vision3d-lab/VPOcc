...
class VPOccDecoder(nn.Module):
    def __init__(self,
        ...
        self.voxel_proposal = VoxelProposalLayerWarp(embed_dims, scene_shape, num_layers=num_layers, 
    ...
    def forward(self, vanishing_point, feats_dict, depth, K, E, voxel_origin, projected_pix,
        ...
        origin_scene_embed = self.voxel_proposal(origin_scene_embed, feats, scene_pos, vol_pts, ref_pix)
